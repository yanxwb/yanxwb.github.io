...
### Relational In-Context Learning via Synthetic Pre-training with Structural Prior [ICML 2026]

- **Authors:** **Yanbo Wang**, Jiaxuan You, Chuan Shi, Muhan Zhang
- **Description:** This paper proposes a first-time synthetic-only pre-training method for relational database in-context learning foundation models, which leverages a universal relational generator with structural priors to generate synthetic RDBs.
- **Link:** [Arxiv](https://arxiv.org/abs/2603.03805)
